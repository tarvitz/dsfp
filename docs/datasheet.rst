...
|                 |         |            |                                   | choice (**1**)      |
+-----------------+---------+------------+-----------------------------------+---------------------+
| **0x126**       | 1 Bytes | c_bool     | Class                             | Depends on your     |
|                 |         |            |                                   | choice (**6**)      |
+-----------------+---------+------------+-----------------------------------+---------------------+
| **0x127**       | 1 Bytes | c_bool     | Body                              | Depends on your     |
|                 |         |            |                                   | choice (**0**)      |
+-----------------+---------+------------+-----------------------------------+---------------------+
| **0x128**       | 1 Bytes | c_bool     | Gift                              | Depends on your     |
|                 |         |            |                                   | choice (**1**)      |
+-----------------+---------+------------+-----------------------------------+---------------------+
| **0x16c**       | 1 Bytes | c_bool     | Face                              | Depends on your     |
|                 |         |            |                                   | choice (**6**)      |
+-----------------+---------+------------+-----------------------------------+---------------------+
| **0x16d**       | 1 Bytes | c_bool     | Hairs                             | Depends on your     |
|                 |         |            |                                   | choice (**6**)      |
+-----------------+---------+------------+-----------------------------------+---------------------+
| **0x16e**       | 1 Bytes | c_bool     | Color                             | Depends on your     |
|                 |         |            |                                   | choice (**6**)      |
+-----------------+---------+------------+-----------------------------------+---------------------+
| skip                                                                                             |
+-----------------+---------+------------+-----------------------------------+---------------------+
